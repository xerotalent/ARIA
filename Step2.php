...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron" style="padding: 2rem 2rem !important;">
            ...
            <h2 class="text-warning"><i class="fa fa-exclamation-circle"></i> Prepare Competition for Pre-Ranking
            </h2>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-2 col-lg-2 col-sm-12">
                ...
                <p class="text-center">
                    <a class="btn btn-secondary btn-sm btn-block" style="color: white!important;" href="Step1.php">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center lead">
                    ...
                    <br />
                    <ul class="text-left">
                        <li>&bull; &nbsp; The Activity Objectives (2);</li>
                        <li>&bull; &nbsp; Knowledge Exchange/Dissemination (3);</li>
                        <li>&bull; &nbsp; Feasibility (2)</li>
                    </ul>
    ...
    <script>
        ...
        $('#generateRanking').click(function(e) {
            ...
            setTimeout(function() {
                window.location.href = "Results.php"; //will redirect to results page
